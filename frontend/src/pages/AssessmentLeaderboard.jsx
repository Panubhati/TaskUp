...
const AssessmentLeaderboard = () => {
  ...
  const fetchLeaderboard = async () => {
    try {
      const res = await axios.get(`${API}/assessments/${id}/leaderboard`, {
      ...
      <div style={S.container}>
        ...
        {data && (
          <>
            {/* Header */}
            <div style={S.header}>
              <div style={S.tag}>ASSESSMENT LEADERBOARD</div>
              <h1 style={S.title}>🏆 {data.assessmentTitle}</h1>
              <p style={S.subtitle}>Only you (the assessment creator) can see this leaderboard</p>
            </div>
            ...
            {data.leaderboard.length > 0 ? (
              ...
              <div style={S.emptyState}>
                ...
                <p style={{ color: '#5a5a66', fontSize: '0.9rem' }}>
                  Students haven't attempted this assessment yet. Share it and check back later.
                </p>
              </div>
            )}
          </>
